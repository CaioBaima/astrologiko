...
def ver_mapa_astral():
    ...
    while voltar != 0:
        ...
        preencher_nome = driver.find_element(By.XPATH,
                                    '/html/body/div[3]/div/div[2]/table/tbody/tr/td/form/table/tbody/tr[1]/td/input[5]').send_keys(nome)

        # Preencher gênero
        sem_genero = driver.find_element(By.XPATH,
                                    '/html/body/div[3]/div/div[2]/table/tbody/tr/td/form/table/tbody/tr[1]/td/input[8]').click()
        ...
        preencher_cidade = driver.find_element(By.XPATH,
                                            '/html/body/div[3]/div/div[2]/table/tbody/tr/td/form/table/tbody/tr[4]/td/table/tbody/tr/td/div/div[1]/input').send_keys(cidade)
        ...
        # Clicar no botão
        Submit = driver.find_element(By.XPATH, '/html/body/div[3]/div/div[2]/table/tbody/tr/td/form/table/tbody/tr[5]/td/button')
        Submit.click()


        mapa = driver.find_element(By.XPATH, '/html/body/div[3]/div/div[2]/div[3]/div[1]/table').text

        ascendente = driver.find_element(By.XPATH, '//*[@id="tablesmallid"]/div[2]/table/tbody/tr[2]').text

        sol = mapa[(mapa.find('Sol ')):(mapa.find('Lua'))]
        lua = mapa[(mapa.find('Lua ')):].replace('Mercurio', 'Mercúrio').replace('Venus', 'Vênus').replace('Nodo N', 'Nodo Lunar Norte')
